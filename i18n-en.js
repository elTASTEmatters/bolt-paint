...
(function(){
  ...
  var D = {
    ...
    "Fraccionamientos":"Housing developments","Fraccionamiento":"Housing development","Vivienda en serie":"Tract housing","Residencial":"Residential","Fraccionamientos y vivienda en serie":"Housing developments & tract housing",
    "Descuento residencial # %":"Residential discount # %","Descuento residencial # % (materiales)":"Residential discount # % (materials)","Descuento residencial # % (aplicación)":"Residential discount # % (application)",
    "📎 Te adjunto el PDF del presupuesto":"📎 The quote PDF is attached","⏳ Generando el PDF del presupuesto…":"⏳ Generating the quote PDF…","📎 PDF compartido: elige WhatsApp y el chat de Bolt Paint (686 262 5119)":"📎 PDF shared: choose WhatsApp and the Bolt Paint chat (686 262 5119)",
    "Nombre y WhatsApp son obligatorios. Al enviar por WhatsApp se comparte el PDF del presupuesto (en computadora se descarga para que lo adjuntes al chat).":"Name and WhatsApp are required. Sending by WhatsApp shares the quote PDF (on a computer it downloads so you can attach it to the chat).",
    "Cotiza por modelo de casa y número de viviendas: pintura de fachada, impermeabilizante y aplicación, con 15 % de descuento a partir de 4 casas.":"Quote by house model and number of homes: facade paint, waterproofing and application, with 15 % off from 4 homes.",
    "Captura cada modelo de casa con su lote, las áreas a pintar e impermeabilizar y cuántas viviendas son. Materiales y aplicación se cotizan por separado; con 4 o más viviendas aplica 15 % de descuento en ambos.":"Enter each house model with its lot, the areas to paint and waterproof, and how many homes. Materials and application are quoted separately; with 4 or more homes a 15 % discount applies to both.",
    "Modelos de casa y número de viviendas":"House models and number of homes",
    "Un renglón por modelo. Escribe el lote y “Estimar por lote” sugiere las áreas (muros: perímetro × 2.7 m por nivel − 15 % de huecos · losa: 80 % del lote); siempre puedes corregirlas.":"One row per model. Enter the lot and “Estimate from lot” suggests the areas (walls: perimeter × 2.7 m per level − 15 % openings · slab: 80 % of the lot); you can always correct them.",
    "Modelo #":"Model #","Quitar":"Remove","Nombre del modelo":"Model name","Ej. Modelo Mar":"e.g. Sea Model","Tamaño de lote (m)":"Lot size (m)","Niveles":"Levels","Área para pintura (m²)":"Area for paint (m²)","Área para impermeabilizante (m²)":"Area for waterproofing (m²)","Cantidad de casas":"Number of houses","Estimar por lote":"Estimate from lot","sugerido # m²":"suggested # m²","+ Agregar otro modelo":"+ Add another model",
    "Lote # × # m (# m²) · # nivel ·":"Lot # × # m (# m²) · # level ·","Lote # × # m (# m²) · # niveles ·":"Lot # × # m (# m²) · # levels ·","# casas":"# houses","# casa":"# house","→ pintura":"→ paint","· losa":"· slab","en total":"in total",
    "Un color de fachada para todo el fraccionamiento (el mismo tono en cada casa). Rendimiento 8.6 m²/L (350 ft²/galón), 2 manos y 10 % de desperdicio.":"One facade color for the whole development (same shade on every house). Coverage 8.6 m²/L (350 sq ft/gallon), 2 coats and 10 % waste.",
    "Elige color y sistema; las cubetas se calculan con los m² de losa de todos los modelos.":"Choose color and system; buckets are calculated from the slab m² of all models.",
    "Mano de obra sobre los mismos m² del material, a $#/m². Sujeto a validación en sitio.":"Labor on the same m² as the material, at $#/m². Subject to on-site validation.",
    "Aplicación de pintura":"Paint application","(# m² × $#)":"(# m² × $#)","(sin m² de losa)":"(no slab m²)","Subtotal servicios:":"Services subtotal:","$# con # %":"$# with # % off",
    "Descuento fraccionamiento # %":"Development discount # %","aplicado en materiales y aplicación (# viviendas)":"applied to materials and application (# homes)","Con":"With","4 o más viviendas":"4 or more homes","aplica # % en materiales y aplicación (llevas #)":"# % applies to materials and application (you have #)",
    "# modelo(s) · # vivienda(s)":"# model(s) · # home(s)","# m² pintura · # m² losa":"# m² paint · # m² slab",
    "entrega en obra · 10 días o menos":"delivered on site · 10 days or less","mano de obra · m² sujetos a validación en sitio":"labor · m² subject to on-site validation",
    "Descuento fraccionamiento # % (materiales)":"Development discount # % (materials)","Descuento fraccionamiento # % (aplicación)":"Development discount # % (application)",
    "Aplicación de pintura · # manos":"Paint application · # coats","Sin aplicación · solo material":"No application · material only","Sin descuento (menos de 4 viviendas)":"No discount (fewer than 4 homes)",
    "Modelos de casa":"House models","Modelos":"Models","Modelo":"Model","casas":"houses","lote":"lot","pintura":"paint","losa":"slab","# niv.":"# lvl.",
    "Áreas estimadas por el lote; puedes corregirlas":"Areas estimated from the lot; you can correct them",
    ...
    "📲 Enviar cotización por WhatsApp":"📲 Send quote by WhatsApp","📲 Enviar cotización (PDF) por WhatsApp":"📲 Send quote (PDF) by WhatsApp","📎 Te adjunto el PDF de la cotización":"📎 The quote PDF is attached","Generando el PDF de la cotización…":"Generating the quote PDF…","PDF compartido: elige WhatsApp y el chat de Bolt Paint":"PDF shared: choose WhatsApp and the Bolt Paint chat","PDF descargado: adjúntalo en el chat de WhatsApp":"PDF downloaded: attach it in the WhatsApp chat","No se pudo generar el PDF; se envió el resumen en texto":"Couldn't generate the PDF; the summary was sent as text","🖨️ Imprimir / PDF":"🖨️ Print / PDF","📋 Copiar texto":"📋 Copy text","Comprar los colores en la tienda →":"Buy the colors in the store →",
